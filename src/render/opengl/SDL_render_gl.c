...
#ifdef __MACOSX__ // intel core profile does have support for NPOT but not report, so ignore checking
    if(1){
#else
...
#ifdef __MACOSX__ // intel core profile does have support for FBO but not report, so ignore checking
    if(1){
#else
