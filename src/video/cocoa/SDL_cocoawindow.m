...
{ @autoreleasepool
{
    ...
    // fix macOS OpenGL problem: color not managed
    // declare original colorspace as sRGB, avoid color changing due to color profile when game start
    // this cannot be done in C code, since objc/c interoperability oftern causes dead-locking
